...
[>>>>> Click here to see the Deployed Weather Dashboard browser application <<<<<](https://csalhab.github.io/weather-dashboard/)

## Technologies Used

JQuery, Web API, localStorage, Open Weather Map's API.
